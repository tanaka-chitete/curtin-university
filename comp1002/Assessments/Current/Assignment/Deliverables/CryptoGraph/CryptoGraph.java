...
public class CryptoGraph {
    ...
    public static void main(String[] args) {
        ...
        if (argc != INTERACTIVE_ARG_COUNT && argc != REPORT_ARG_COUNT) {
            ...
            System.out.println("Usage (Interactive): java CryptoGraph -i");
            System.out.println("or");
            System.out.println("Usage (Report): java CryptoGraph -r <asset filename>.json " + 
                "<trade filename>.json");
        }
        else {
            mode = args[0];
            ...
            // User specifies Report
                ...
                if (argc != REPORT_ARG_COUNT) {
                    ...
                    System.out.println("Usage (Report): java CryptoGraph -r <asset filename> " + 
                        "<trade filename>");
                }
                // Runs in Report
                else {
