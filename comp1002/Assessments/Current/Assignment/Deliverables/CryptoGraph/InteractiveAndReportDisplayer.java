...
public class InteractiveAndReportDisplayer {
    ...
    public static void displayAllTradePairs(JSONArray pairs, DSAHashSet excludedAssets) {
        ...
        System.out.println("\nNumber of Visible Trade Pairs: " + tradePairCount);
        System.out.println("Total Number of Trade Pairs: " + pairs.length() + "\n");
    ...
    public static void displayRecentTrades(JSONArray recentTrades, 
        ...
        for (int i = 0; i < recentTrades.length(); i++) {
            ...
            System.out.println(iOne + ". " + statDisp + ": " + currStat);
        }
        System.out.println();
    }
}