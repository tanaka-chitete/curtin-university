...
class SortsTestHarness 
{
    ...
    private static void usage() 
    {
        ...
        System.out.println("           t - quicksort (Median-of-Three)");
        System.out.println("           w - quicksort (Three-Way)");
        System.out.println("           m - mergesort");
        System.out.println("           h - shellsort");
        System.out.println("           c - countingsort");
...
//                    long startTime = System.currentTimeMillis();
                    ...
                    switch (sortType)
                    {
                        ...
                        case 't' : Sorts.quickSortM3(A); break;
                        case 'w' : Sorts.quickSort3W(A); break;
