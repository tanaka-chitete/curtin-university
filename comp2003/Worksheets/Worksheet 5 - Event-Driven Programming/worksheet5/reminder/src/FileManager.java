 ...
 */
public class FileManager implements ReminderListObserver
{
    private Controller controller;

    public FileManager (Controller inController) {
    ...
    public void reminderListUpdated() {
        try {
            write(Controller.REMINDER_FILE, controller.getReminders());
        }
        catch (IOException e) {
            System.err.println("Error: unable save reminders to file!");
        }
    }
}
